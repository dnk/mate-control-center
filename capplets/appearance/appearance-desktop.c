...
create_button_images (AppearanceData  *data)
{
  ...
  icon_info = gtk_icon_theme_lookup_icon (icon_theme, "media-playback-start", icon_size, 0);
  pb = gtk_icon_info_load_icon (icon_info, NULL);
  pb2 = g_object_ref (pb);
#elif GTK_CHECK_VERSION (3, 0, 0)
  icon_set = gtk_style_context_lookup_icon_set (style, "gtk-media-play");
  pb = gtk_icon_set_render_icon_pixbuf (icon_set, style, GTK_ICON_SIZE_MENU);
  pb2 = gtk_icon_set_render_icon_pixbuf (icon_set, style, GTK_ICON_SIZE_MENU);
#else
